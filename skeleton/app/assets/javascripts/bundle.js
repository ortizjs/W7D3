...
var RECEIVE_ALL_POKEMON = "RECEIVE_ALL_POKEMON"; // export const RECEIVE_ALL_POKEMON = "RECEIVE_ALL_POKEMON"
...
function (_React$Component) {
  ...
  _createClass(PokemonIndex, [{
    ...
    value: function render() {
      var allPokemons = this.props.pokemon.map(function (pokemon) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, allPokemons);
    }
  }]);
...
var selectAllPokemon = function selectAllPokemon(state) {
  var result = Object.values(state.entities.pokemon).map(function (pokemon) {
    return pokemon;
  });
  return result;
};
